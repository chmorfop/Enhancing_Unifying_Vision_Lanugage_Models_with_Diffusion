...
def main(clip_model_type: str):
    ...
    out_path = f"/content/clipcap/data/visdial/clip_feat_{clip_model_name}_train_vqa.pkl"
    ...
    for i in tqdm(range(len(dialogs))):
        ...
        for d in dialogs[i].get('dialog'):
            temp_dict = {'question': questions[d.get('question')],
                         'answer': answers[d.get('answer')],
                         'clip_embedding': global_counter,
