...
def main():
    myconfig = {
        'epochs': 10,
        'batch_size': 32,
        'train_data_ic': '/scratch/chris.morfopoulos/data/vizwiz/clip_feat_ViT-B_32_train_ic.pkl',
        'val_data_ic': '/scratch/chris.morfopoulos/data/vizwiz/clip_feat_ViT-B_32_val_ic.pkl',
        'train_data_vqa': '/scratch/chris.morfopoulos/data/vizwiz/clip_feat_ViT-B_32_train_vqa.pkl',
        'val_data_vqa': '/scratch/chris.morfopoulos/data/vizwiz/clip_feat_ViT-B_32_val_vqa.pkl',
        'out_dir': '/scratch/chris.morfopoulos/temp_code/ablation_/vizwiz_abl/vizwiz_MTL_B_64IC_16VQA',
        'weight_loss_ic': 0.5,
        'weight_loss_vqa': 0.5,
        'save_every': 1,
        'prefix_length': 10,
        ...
        'is_rn': False,
        'normalize_prefix': False,
        'model_name': 'vizwiz_MTL_B_64IC_16VQA',
        'weights_path': ''
    ...
    train_dataloader_ic = DataLoader(train_dataset_ic, batch_size=64, shuffle=True,
                                     drop_last=False)
    val_dataloader_ic = DataLoader(val_dataset_ic, batch_size=64, shuffle=True,
                                   drop_last=False)

    train_dataloader_vqa = DataLoader(train_dataset_vqa, batch_size=16, shuffle=True,
                                      drop_last=False)
    val_dataloader_vqa = DataLoader(val_dataset_vqa, batch_size=16, shuffle=True,
                                    drop_last=False)
