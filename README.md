...
![Example Image from TextCaps](images_md/1.png)

![Example Image from COCO](images_md/5.png)

**VQA & Captioning results generated by our model MTL CS,**:
![Image Captioning](images_md/2.png)
  
![Visual Question Answering](images_md/4.png)
