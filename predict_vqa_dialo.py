...
mypredictor = Predictor(weights_path=
                        '/content/drive/MyDrive/Colab Notebooks/COCO/ClipCap_Models/my_dialogpt_vqa_model_bestmodel.pt')
...
for step in range(step_threshold):
    ...
    if actions.lower() == 'text':
        ...
        output = mypredictor.predict(image_path=user_path, use_beam_search=False, question=modified_question)
        print("DialoGPT : {}".format(output))
    print()
    print()
